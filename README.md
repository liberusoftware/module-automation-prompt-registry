...
[![Latest release](https://img.shields.io/github/v/release/liberusoftware/module-automation-prompt-registry?sort=semver)](https://github.com/liberusoftware/module-automation-prompt-registry/releases/latest) [![Tests](https://github.com/liberusoftware/module-automation-prompt-registry/actions/workflows/tests.yml/badge.svg?branch=main)](https://github.com/liberusoftware/module-automation-prompt-registry/actions/workflows/tests.yml)
...
```bash
composer require liberusoftware/module-automation-prompt-registry
```
...
<a href="https://github.com/liberusoftware/module-automation-prompt-registry/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=liberusoftware/module-automation-prompt-registry" alt="Contributors to liberusoftware/module-automation-prompt-registry">
</a>

[View the full contributors graph](https://github.com/liberusoftware/module-automation-prompt-registry/graphs/contributors).
